...
class DataIngestion:
    ...
    def initiate_data_ingesion(self):
        ...
        try :
            ...
            df = pd.read_excel(r"F:\study material\Data Science\iNeuron-FullStack-DataSciene-Assignments\modular coding assignment\Credit-card-default\notebooks\data\default of credit card clients.xls",header=1)
            ...
            df.to_csv(self.ingesion_config.raw_data_path,index=False,header=1)
            ...
            train_set.to_csv(self.ingesion_config.train_data_path,index = False,header=1)
            test_set.to_csv(self.ingesion_config.test_data_path,index = False,header=1)
